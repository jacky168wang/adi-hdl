...
set_property -dict {PACKAGE_PIN Y25 IOSTANDARD LVCMOS25} [get_ports {gpio_bd[4]}]
...
set_property -dict {PACKAGE_PIN F5 IOSTANDARD LVCMOS15} [get_ports {gpio_bd[7]}]
set_property -dict {PACKAGE_PIN G2 IOSTANDARD LVCMOS15} [get_ports {gpio_bd[8]}]
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS15} [get_ports {gpio_bd[9]}]
...
set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS15} [get_ports {gpio_bd[12]}]
set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS15} [get_ports {gpio_bd[13]}]
