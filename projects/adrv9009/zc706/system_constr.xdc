...
set_property  -dict {PACKAGE_PIN  AH23  IOSTANDARD LVCMOS25} [get_ports spi_clk_ad9528]                 ; ## D11  FMC_HPC_LA05_P
set_property  -dict {PACKAGE_PIN  AH24  IOSTANDARD LVCMOS25} [get_ports spi_mosi_ad9528]                ; ## D12  FMC_HPC_LA05_N
set_property  -dict {PACKAGE_PIN  AG19  IOSTANDARD LVCMOS25  PULLTYPE PULLUP} \
                                                             [get_ports spi_miso_ad9528]                ; ## G13  FMC_HPC_LA08_N

set_property  -dict {PACKAGE_PIN  AD21  IOSTANDARD LVCMOS25} [get_ports spi_csn_adrv9009]               ; ## D14  FMC_HPC_LA09_P
set_property  -dict {PACKAGE_PIN  AJ23  IOSTANDARD LVCMOS25} [get_ports spi_clk_adrv9009]               ; ## H13  FMC_HPC_LA07_P
set_property  -dict {PACKAGE_PIN  AJ24  IOSTANDARD LVCMOS25} [get_ports spi_mosi_adrv9009]              ; ## H14  FMC_HPC_LA07_N
set_property  -dict {PACKAGE_PIN  AF19  IOSTANDARD LVCMOS25  PULLTYPE PULLUP} \
                                                             [get_ports spi_miso_adrv9009]              ; ## G12  FMC_HPC_LA08_P
...
set_property  -dict {PACKAGE_PIN  AF24  IOSTANDARD LVCMOS25} [get_ports adrv9009_gpio_13]               ; ## G16  FMC_HPC_LA12_N (LVDS Pairs?)
set_property  -dict {PACKAGE_PIN  AF23  IOSTANDARD LVCMOS25} [get_ports adrv9009_gpio_14]               ; ## G15  FMC_HPC_LA12_P (LVDS Pairs?)
set_property  -dict {PACKAGE_PIN  V27   IOSTANDARD LVCMOS25} [get_ports adrv9009_gpio_15]               ; ## G24  FMC_HPC_LA22_P     (LVDS Pairs?)
set_property  -dict {PACKAGE_PIN  AH22  IOSTANDARD LVCMOS25} [get_ports adrv9009_gpio_16]               ; ## C11  FMC_HPC_LA06_N (LVDS Pairs?)
set_property  -dict {PACKAGE_PIN  AG22  IOSTANDARD LVCMOS25} [get_ports adrv9009_gpio_17]               ; ## C10  FMC_HPC_LA06_P (LVDS Pairs?)
