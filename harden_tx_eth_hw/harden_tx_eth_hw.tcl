...
# Fri Feb 1 16:31:53 GMT+08:00 2018
# DO NOT MODIFY


# 
# harden_tx "harden_tx" v1.0
# Royce Ai Yu Pan 2018.01.12.11:38:53
# harden transmission data path
# 
...
# module harden_tx
# 
set_module_property DESCRIPTION "harden transmission data path"
set_module_property NAME harden_tx_eth
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "FACC 5G"
set_module_property AUTHOR  Royce Ai Yu Pan
set_module_property DISPLAY_NAME harden_tx_eth
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL harden_tx
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false

add_fileset_file harden_tx.v VERILOG PATH harden_tx.v TOP_LEVEL_FILE
add_fileset_file cp_insertion.sv SYSTEM_VERILOG PATH cp_insertion.sv
add_fileset_file sc_map.sv SYSTEM_VERILOG PATH sc_map.sv
add_fileset_file util_blocfifo.sv SYSTEM_VERILOG PATH util_blocfifo.sv
add_fileset_file decompression.v VERILOG PATH decompression.v
add_fileset_file util_fft.v VERILOG PATH util_fft.v
add_fileset_file util_scaler.v VERILOG PATH util_scaler.v
add_fileset_file util_fifo2avl.v VERILOG PATH util_fifo2avl.v
...
#  CP_LEN1
add_parameter CP_LEN1 INTEGER 320
set_parameter_property CP_LEN1 DEFAULT_VALUE 320
...
#                                                                    
# connection point fast_clk                                           
#                                                                    
add_interface fast_clk clock end                                      
set_interface_property fast_clk clockRate 0                           
set_interface_property fast_clk ENABLED true                          
set_interface_property fast_clk EXPORT_OF ""                          
set_interface_property fast_clk PORT_NAME_MAP ""                      
set_interface_property fast_clk CMSIS_SVD_VARIABLES ""                
set_interface_property fast_clk SVD_ADDRESS_GROUP ""                  
                                                                     
add_interface_port fast_clk fast_clk clk Input 1                  
...
add_interface_port sync_ctrl sync_symbol symbol  Input 4   
add_interface_port sync_ctrl sync_slot slot Input 8       
add_interface_port sync_ctrl sync_frame frame Input 10        
...
add_interface_port pdsch_ante_0 din0_data   data   Input 64                  
add_interface_port pdsch_ante_0 din0_sop    sop    Input 1                   
add_interface_port pdsch_ante_0 din0_eop    eop    Input 1                   
add_interface_port pdsch_ante_0 din0_valid  valid  Input 1  
add_interface_port pdsch_ante_0 din0_symbol symbol Input 4  
add_interface_port pdsch_ante_0 din0_slot   slot   Input 8  
add_interface_port pdsch_ante_0 din0_frame  frame  Input 10  
...
add_interface_port pdsch_ante_1 din1_data   data   Input 64                    
add_interface_port pdsch_ante_1 din1_sop    sop    Input 1                     
add_interface_port pdsch_ante_1 din1_eop    eop    Input 1                     
add_interface_port pdsch_ante_1 din1_valid  valid  Input 1  
add_interface_port pdsch_ante_1 din1_symbol symbol Input 4   
add_interface_port pdsch_ante_1 din1_slot   slot   Input 8   
add_interface_port pdsch_ante_1 din1_frame  frame  Input 10                     
...
# 
# connection point dac_ch_0_axi
# 
add_interface dac_ch_0_axi conduit end
set_interface_property dac_ch_0_axi associatedClock link_clk
set_interface_property dac_ch_0_axi associatedReset ""
set_interface_property dac_ch_0_axi ENABLED true
set_interface_property dac_ch_0_axi EXPORT_OF ""
set_interface_property dac_ch_0_axi PORT_NAME_MAP ""
set_interface_property dac_ch_0_axi CMSIS_SVD_VARIABLES ""
set_interface_property dac_ch_0_axi SVD_ADDRESS_GROUP ""

add_interface_port dac_ch_0_axi data_out_i0 data Output 32     
add_interface_port dac_ch_0_axi enable_in_i0 enable Input 1      
add_interface_port dac_ch_0_axi valid_in_i0 valid Input 1      

#                                                                                                                                                                                                                                                                   
# connection point dac_ch_1_axi                                                                                                                                                                                                                                   
#                                                                                                                                                                                                                                                                   
add_interface dac_ch_1_axi conduit end                                                                                                                                                                                                                            
set_interface_property dac_ch_1_axi associatedClock link_clk                                                                                                                                                                                                      
set_interface_property dac_ch_1_axi associatedReset ""                                                                                                                                                                                                            
set_interface_property dac_ch_1_axi ENABLED true                                                                                                                                                                                                                  
set_interface_property dac_ch_1_axi EXPORT_OF ""                                                                                                                                                                                                                  
set_interface_property dac_ch_1_axi PORT_NAME_MAP ""                                                                                                                                                                                                              
set_interface_property dac_ch_1_axi CMSIS_SVD_VARIABLES ""                                                                                                                                                                                                        
set_interface_property dac_ch_1_axi SVD_ADDRESS_GROUP ""                                                                                                                                                                                                          
                                                                                                                                                                                                                                                                    
add_interface_port dac_ch_1_axi data_out_q0 data Output 32                                                                                                                                                                                                   
add_interface_port dac_ch_1_axi enable_in_q0 enable Input 1                                                                                                                                                                                               
add_interface_port dac_ch_1_axi valid_in_q0 valid Input 1                                                                                                                                                                                                 
                                                                                                                                                                                                                                                                    
#                                                                     
# connection point dac_ch_2_axi                                                  
#                                                                                  
add_interface dac_ch_2_axi conduit end                                           
set_interface_property dac_ch_2_axi associatedClock link_clk                     
set_interface_property dac_ch_2_axi associatedReset ""                           
set_interface_property dac_ch_2_axi ENABLED true                                 
set_interface_property dac_ch_2_axi EXPORT_OF ""                                 
set_interface_property dac_ch_2_axi PORT_NAME_MAP ""                             
set_interface_property dac_ch_2_axi CMSIS_SVD_VARIABLES ""                       
set_interface_property dac_ch_2_axi SVD_ADDRESS_GROUP ""                         
                                                                                   
add_interface_port dac_ch_2_axi data_out_i1 data Output 32                    
add_interface_port dac_ch_2_axi enable_in_i1 enable Input 1                 
add_interface_port dac_ch_2_axi valid_in_i1 valid Input 1                   
                                                                                   
#                                                                     
# connection point dac_ch_3_axi                                                  
#                                                                                    
add_interface dac_ch_3_axi conduit end
set_interface_property dac_ch_3_axi associatedClock link_clk
set_interface_property dac_ch_3_axi associatedReset ""
set_interface_property dac_ch_3_axi ENABLED true
set_interface_property dac_ch_3_axi EXPORT_OF ""
set_interface_property dac_ch_3_axi PORT_NAME_MAP ""
set_interface_property dac_ch_3_axi CMSIS_SVD_VARIABLES ""
set_interface_property dac_ch_3_axi SVD_ADDRESS_GROUP ""

add_interface_port dac_ch_3_axi data_out_q1 data Output 32     
add_interface_port dac_ch_3_axi enable_in_q1 enable Input 1      
add_interface_port dac_ch_3_axi valid_in_q1 valid Input 1      
...
add_interface_port gp_status gp_status_2 export_2 Output 32      
add_interface_port gp_status gp_status_3 export_3 Output 32 
add_interface_port gp_status gp_status_4 export_4 Output 32 
add_interface_port gp_status gp_status_5 export_5 Output 32 
